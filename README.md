...
> **Примечание:** Видео содержит пошаговую демонстрацию процесса активации JetBrains IDE с объяснениями всех этапов.

🎬 **[Скачать видео файл](Instructions.mp4)** (если видео выше не воспроизводится)
